# ROTEIRO FINAL — RMS Titanic: A Arquitetura do Desastre

> Squad doc-safety | Fase 11 — Roteiro Final Consolidado | McKee (5 beats) + Bernard (3 atos)
> Autor: @roteirista | Data: 2026-02-26
> Consolidacao: Fases 6 (Escaleta) + 7 (Entrevistas) + 8 (Direcao Visual) + 9 (Cenografia) + 10 (Licoes Aprendidas)
...
| **Duracao** | 90 minutos |
| **Diretor (estilo)** | James Cameron — rigor tecnico + espetaculo visual + mergulho forense |
...
| **Cultura de seguranca** | Hopkins 5 indicadores + Schein 3 niveis + Westrum tipologia + Reason 4 subculturas |
| **Analise tecnica** | Foecke/McCarty (NIST/JHU) — metalurgia dos rebites |
| **Estrutura** | 3 atos (Bernard) / 5 beats (McKee) / 17 sequencias / 4 blocos |
| **Status** | FINAL DRAFT |
...
|---|------|--------|-----------|---------------------|
| 1 | Dr. Tim Foecke (NIST) | Metalurgista forense — o DNA do desastre | SEQ 02, 06, 11 | Interrotron. Laboratorio NIST. Key light lateral 4800K. Bancada com rebites ao fundo. Ratio 4:1 |
| 2 | Parks Stephenson | Historiador naval — sistema Marconi | SEQ 07, 10 | Interrotron. Equipamento de comunicacao ao fundo. Key frontal-lateral 3800K. Telas com ambar Marconi |
| 3 | Dr. Jennifer Hooper McCarty (JHU) | Historiadora da metalurgia — arquivos H&W | SEQ 11 | Interrotron. Mesa academica. Documentos H&W. Iluminacao quente de biblioteca |
| 4 | Daniel Allen Butler | Historiador — psicologia de Smith, cultura edwardiana | SEQ 02, 05, 09 | Entrevista longa. Rembrandt lighting 3200K. Escritorio com mapas e livros |
| 5 | Especialista em Seguranca Moderna (a definir) | Safety science — ponte passado-presente | SEQ 15, 16 | Interrotron. Escritorio moderno. Key lateral 5600K. Tela com Boeing/Grenfell |
| 6 | Don Lynch / Ken Marschall | Visual history — expedicoes ao wreck | SEQ 01, 17 | Marschall: pinturas ao fundo. Lynch: artefatos THS. Soft box 3800K |
...
|------------|------------------|---------------------|-----------|
| Thomas Andrews | Protagonista tragico — sabia e nao podia mudar | N2 (fragmentado) | SEQ 03, 06, 12 |
| Alexander Carlisle | Whistleblower silenciado — Cassandra do Titanic | N2 (fragmentado) | SEQ 03, 04, 08, 12 |
| J. Bruce Ismay | Antagonista sistemico — pressao comercial | N2 (fragmentado) | SEQ 03, 05, 09 |
| Capitao Edward Smith | Local Rationality encarnada — 40 anos de experiencia como armadilha | N3 (estilistico) | SEQ 05, 09 |
| Jack Phillips | Vitima do sistema duplo — Marconi vs White Star | N3 (estilistico) | SEQ 07, 12 |
| Frederick Fleet | Ultima defesa num sistema quebrado | N3 (estilistico) | SEQ 05 |
| Board of Trade | Regulacao capturada — camada organizacional Reason | N1 (simbolico) | SEQ 08, 14 |
...
**Cores auxiliares:** Vermelho Alerta (#8B2500) — foguetes, Swiss Cheese. Ambar Marconi (#D4A017) — sala de radio. Branco Flash (#FFFFFF) — instante da colisao.
...
**ATO I | ~22 minutos | Beat 1 (Vida Normal) + inicio Beat 2 (Inciting Incident)**
**Value-Charge: POSITIVO --> NEGATIVO**
**Arco cromatico: Azul Abissal --> Ouro Edwardiano --> Sepia Belfast --> FLASH BRANCO --> Escuridao**

---

## SEQ 01 — PROLOGO: O CRIME SCENE

| Campo | Detalhe |
|-------|---------|
| **Duracao** | 3 minutos |
| **Tipo de material** | Arquivo submarino (acervo Cameron, 33 mergulhos) + VO |
| **Paleta** | Azul Atlantico #1B3A5C dominante + Preto Abissal #0A0A0F |
| **Entrevistados** | Nenhum (VO Cameron). Ken Marschall como fonte visual complementar |
| **Props/cenografia** | Nenhuma construcao — imagens reais do wreck |
...
Depois: som subaquatico. O murmúrio do abismo. Pressao. Escuridao quase absoluta.
...
**VO (Cameron):** "Mergulhei 33 vezes ate este navio. Cada vez que desci, encontrei algo que nao esperava. Nao uma relíquia. Nao um tesouro. Uma pergunta. A mesma pergunta, a 3.800 metros de profundidade: como foi possivel?"
...
**VO (Cameron):** "Este nao e um navio naufragado. E uma cena de crime."

**CORTE SECO.**

**SOM:** O estrondo de um martelo sobre metal. Aco brilhante. Belfast, 1909.

**NOTA DE DIRECAO VISUAL:** O episodio abre no azul-preto monocromatico. A primeira imagem e quase sem cor. A luz artificial dos ROVs e a unica fonte — recorta a proa como um altar esquecido. Quando Cameron diz "crime scene," a palavra redefine o que o azul significa: nao e beleza maritima, e cena de crime. O contraste entre SEQ 01 e SEQ 02 e o MAIOR do episodio — do azul abissal para o dourado industrial. Corte SECO, nao fade. O choque cromatico e deliberado.

**SOM/MUSICA:** Sons subaquaticos naturais (gravados em mergulho). Nenhuma musica. O silencio do fundo do mar E a musica. O corte para Belfast traz o metalico industrial como ruptura sonora.
...
CORTE. A frase fica suspensa. Nao revelamos. O espectador recebe a semente do conflito — sera cultivada por 50 minutos antes de florescer na SEQ 11.
...
## SEQ 04 — A VOZ QUE NINGUEM OUVIU
...
**VO (Cameron):** "Cinco anos antes do naufragio, um homem sentou-se numa sala e disse o que era preciso fazer. A sala nao ouviu. A pergunta nao e POR QUE ele falou. A pergunta e por que NINGUEM ouviu."
...
## SEQ 05 — INCITING INCIDENT: 37 SEGUNDOS
...
| **Entrevistados** | Dr. Tim Foecke (NIST), Dr. Jennifer Hooper McCarty (JHU) |
| **Props/cenografia** | Nenhum cenario construido. Props: rebites reais de ferro forjado (replicas metalurgicamente precisas) filmados em macro sobre fundo preto. Mao de Foecke segurando rebite como transicao para CGI |
...
## SEQ 07 — COMPLICACAO 1: OS AVISOS SILENCIADOS
...
**VO (Cameron):** "Jack Phillips nao era negligente. Era um trabalhador de 25 anos seguindo as regras do sistema que o empregava. A Marconi Company pagava-lhe por telegrama. O aviso de gelo nao valia nada. E o aviso era tudo."
...
## SEQ 08 — COMPLICACAO 2: OS BOTES FANTASMA
...
**VO (Cameron):** "O Board of Trade nao errou por incompetencia. Errou por coerencia — foi COERENTE com uma regra que ninguem questionava porque ninguem precisava: nenhum grande navio havia afundado. A regra 'funcionou' por 18 anos. Funcionou ate a noite de 14 de abril."
...
## SEQ 09 — COMPLICACAO 3: A ARITMETICA DA CLASSE

| Campo | Detalhe |
|-------|---------|
| **Duracao** | 8 minutos |
| **Tipo de material** | Reconstituicao N3 (grades entre decks — CRITICA) + grafismo mortalidade + arquivo + entrevista |
...
| **Entrevistados** | Butler (contexto de classe edwardiana, Interrotron) |
| **Props/cenografia** | **Grades entre decks (construcao completa — a imagem mais moralmente carregada do documentario):** Grade de ferro com barras verticais e horizontais. Corredor 1a classe (mais largo, iluminado). Corredor 3a classe (estreito, sombrio, labirintico). Tranca/cadeado na grade. Mao de comissario na tranca. Lampadas de corredor fracas. Sinalizacao minima ou ausente para 3a classe |
...
## SEQ 10 — COMPLICACAO 4: O NAVIO QUE VIU E NAO AGIU
...
## SEQ 11 — COMPLICACAO 5: O DNA DO DESASTRE
...
**Foecke:** "Recuperamos rebites das expedicoes de Cameron ao wreck. Colocamos sob o microscopio. O teor de escoria nos rebites de ferro forjado da proa excedia 3% — em alguns casos, 9%. Isso e... muito. Um rebite com 9% de escoria e fragil. Quebradiço. Quando o gelo empurrou as placas, esses rebites nao resistiram."
...
## SEQ 12 — REVERSAL: AS TRES VOZES SILENCIADAS
...
| **Entrevistados** | Nenhum novo (montagem de material ja captado + VO Cameron) |
...
**VO (Cameron):** "Alexander Carlisle propôs 48 botes. Thomas Andrews propôs anteparas mais altas. Cyril Evans avisou sobre o gelo. Tres homens. Tres alarmes. Tres vezes o sistema fez o que faz: silenciou. O Titanic nao falhou em comunicar. Funcionou como desenhado — para silenciar."

[SILENCIO — 5 segundos]

**VO (Cameron):** "Nenhum desses decisores planejou matar 1.517 pessoas. Cada um fez o que parecia certo. E foi EXATAMENTE por isso que tantos morreram."
...
## SEQ 13 — CLIMAX: O SISTEMA

| Campo | Detalhe |
|-------|---------|
| **Duracao** | 7 minutos |
| **Tipo de material** | CGI Swiss Cheese animado + time-lapse drift + entrevista (montagem) + VO |
| **Paleta** | **P&B TOTAL.** Preto Abissal + Branco Analitico. Unica excecao: Vermelho Alerta #8B2500 para os "buracos" do Swiss Cheese acendendo |
| **Entrevistados** | Montagem de Foecke, Stephenson, Butler, Especialista em Seguranca — nenhuma entrevista nova, montagem de material ja captado convergindo para a revelacao |
...
**VO (Cameron, sobre a animacao):** "James Reason chamou isso de Modelo do Queijo Suiço. Cada camada de protecao tem buracos — falhas normais, previsiveis, aceitaveis. Nenhum buraco sozinho causa desastre. Mas quando os buracos se alinham..."
...
**VO (Cameron):** "Dekker chamou de Local Rationality. Cada decisor agia racionalmente dentro do seu contexto. Ninguem errou. E 1.517 morreram."

[SILENCIO — 3 segundos]

**VO (Cameron):** "Schein disse: o pressuposto mais perigoso e o que nunca precisa ser articulado. O pressuposto do Titanic era: 'Somos grandes demais para falhar.' Ninguem o dizia porque todos o respiravam."

**GRAFISMO:** Score Westrum: 6 de 25 — cultura PATOLOGICA. O numero aparece em branco sobre preto.

**VO (Cameron):** "O Titanic NUNCA foi seguro. O sistema existia para afirmar que era."

**SOM/MUSICA:** Silencio quase total. O som do Swiss Cheese e geometrico — cliques suaves quando os buracos acendem, como um mecanismo de relogio. Quando os buracos se alinham: um tom grave, continuo, ressonante — o som de uma estrutura que cede. Depois: agua. O rugido da agua entrando. Mesmo som da SEQ 06 — mas agora o espectador entende o que ELE significa.
...
**ATO III (parte 2) | ~16 minutos | Beat 5 (Resolution/Legado)**
...
## SEQ 14 — CONSEQUENCIAS: O QUE O MUNDO FEZ
...
| **Entrevistados** | Especialista em Seguranca Moderna (ponte para hoje — primeira aparicao) |
...
**VO (Cameron):** "A ironia do inquerito britanico e que ele praticou EXATAMENTE o mecanismo que deveria condenar. Local Rationality: o juiz fez o que juizes fazem — protegeu a instituicao. Reason chamaria de captura regulatoria. Hopkins chamaria de indicador #2 em FALHA: compromisso da alta gestao com seguranca, quando a 'alta gestao' INCLUI o regulador."
...
**ENTREVISTA (Especialista em Seguranca Moderna — PRIMEIRA APARICAO):** Interrotron. Escritorio moderno, limpo. Tela ao fundo com timeline 1894-1914. Luz 5600K — presente, ordinaria.

**Especialista:** "SOLAS foi uma conquista real. Salvou vidas. Mas SOLAS foi uma resposta ao O QUE aconteceu, nao ao POR QUE aconteceu. O Board of Trade nao foi reformado — foi contornado. A estrutura de captura regulatoria permaneceu."
...
## SEQ 15 — A FIX QUE MATA: EASTLAND + BOEING MAX
...
| **Entrevistados** | Especialista em Seguranca Moderna (momento-chave) |
...
1915. Rio Chicago. 24 de julho. O SS Eastland — um navio de passageiros que JA ERA conhecido por problemas de estabilidade — recebe botes salva-vidas adicionais como parte das novas exigencias pos-Titanic. O peso extra, adicionado ao convés superior, agrava a instabilidade.
...
**VO (Cameron):** "Dekker disse: 'A fix que ataca o sintoma sem entender o sistema cria NOVO desastre.' O SOLAS exigiu botes para todos. Ninguem perguntou: e se o peso dos botes matar antes do naufragio?"

**TRANSICAO — Boeing 737 MAX:** A mesma anatomia, 106 anos depois.

**ENTREVISTA (Especialista):**

**Especialista:** "Em 2018, a FAA delegou ao proprio fabricante — a Boeing — a certificacao do sistema MCAS. A Boeing classificou como 'nao critico.' Dois avioes cairam. Lion Air 610, outubro de 2018: 189 mortos. Ethiopian Airlines 302, marco de 2019: 157 mortos. 346 vidas."

**Pergunta:** "A FAA aprendeu O QUE aconteceu ou POR QUE aconteceu?"

[SILENCIO — 7 segundos]

**Especialista:** "Reformaram o processo de certificacao. Mais supervisores da FAA. Revisao do ODA. Reformas reais. Mas o modelo fundamental — onde o fabricante desenvolve E certifica — permanece. Os incentivos estruturais permanecem. Se aprenderam apenas 'o que,' o proximo 'Eastland' pode ser o proximo aviao com um sistema que a reforma nao previu."

**GRAFISMO COMPARATIVO:** Split-screen triplo. ESQUERDA: Merchant Shipping Act 1894, close na Rule 12. CENTRO: Titanic em perfil, transbordando a regra (grafismo animado do navio crescendo). DIREITA: documento FAA com selo "DELEGATED." Uma LINHA VERMELHA continua conecta as tres imagens — a mesma falha, 106 anos de distancia. A linha pulsa como batimento cardiaco. Quando as tres imagens se alinham, o pulso PARA.
...
## SEQ 16 — PONTE: OS TITANICS DE HOJE
...
| **Entrevistados** | Especialista em Seguranca Moderna (provocacao final) |
| **Props/cenografia** | Nenhuma construcao — montagem editorial |
...
**VO (Cameron):** Nao narra. Cede a voz ao SILENCIO da montagem. As perguntas emergem dos paralelos visuais — nao precisam ser articuladas.

**ENTREVISTA (Especialista — provocacao final):**

**Pergunta:** "Estamos num Titanic agora? Ha um navio navegando a toda velocidade em direcao a um iceberg que todos veem mas ninguem quer nomear?"

[SILENCIO — 10 segundos. O mais longo do documentario.]
...
**Especialista:** "Estamos em 1907. Os davits estao instalados. Os botes ainda nao foram colocados. E ninguem esta prestando atencao porque o navio e lindo e o mar esta calmo."

**VO (Cameron — sobre as imagens finais da montagem):** "Hopkins disse: 'A inseguranca se disfarca de rotina.' Schein disse: 'Observe o que acontece quando alguem reporta um problema.' O Titanic nao e uma historia de 1912. E uma historia de AGORA."

**SOM/MUSICA:** Nenhuma musica. Os paralelos visuais se sucedem em silencio. Quando o Especialista fala de TSMC e IA, o unico som e sua voz e a estatica ambiente do escritorio moderno. A normalidade sonora AMPLIFICA o horror do conteudo. O ordinario e o terrificante.
...
## SEQ 17 — EPILOGO: O MAR

| Campo | Detalhe |
|-------|---------|
| **Duracao** | 3 minutos |
| **Tipo de material** | Arquivo submarino (acervo Cameron) + texto + silencio + VO |
| **Paleta** | Azul Atlantico #1B3A5C --> Preto Abissal #0A0A0F. Circularidade cromatica COMPLETA: azul-abissal abre (SEQ 01), azul-abissal fecha (SEQ 17). Mas a funcao mudou: na abertura era convite, no fechamento e despedida |
| **Entrevistados** | Nenhum. Cameron (VO) fecha sozinho |
...
Depois: ESPELHO. A camera (Cameron) filma uma superficie reflexiva — agua? metal polido? — que devolve o olhar. O conceito de reflexo. O espectador e olhado de volta.

**VO (Cameron):** "Este navio conta uma historia. Nao a historia de um iceberg. A historia de um sistema. De decisoes que pareciam razoaveis. De vozes que foram silenciadas. De uma civilizacao tao apaixonada pelo seu progresso que esqueceu de perguntar: 'e se estivermos errados?'"

[SILENCIO — 5 segundos]

**VO (Cameron):** "Voce nao e Carlisle. Provavelmente nao esta projetando navios nem certificando avioes. Mas voce ESTA dentro de um sistema. E dentro de todo sistema existem regras que 'funcionam' porque nunca foram testadas. Existem sinais de alarme que ninguem ouve porque quem os envia nao tem poder suficiente. Existem drifts — lentos, invisiveis, razoaveis — que estao movendo o baseline do 'normal' para mais perto do iceberg a cada dia em que 'funciona.'"

Fade lento para imagens submarinas do wreck — os sapatos, as luminarias, o silencio.

**VO (Cameron):** "Na proxima reuniao em que alguem disser 'acho que isso pode dar errado' — observe o que acontece. Observe os rostos. Observe o silencio. E pergunte a si mesmo: estou num navio que esta afundando, ou num navio que esta flutuando? Porque em abril de 1912, essas duas coisas eram a mesma coisa."
...
**SOM/MUSICA:** Sons subaquaticos naturais — identicos ao prologo. Circularidade sonora completa. O mesmo murmúrio abissal. Quando Cameron fala, sua voz e a unica presenca humana no azul. Calma, precisa, respeitosa com o que esta no fundo do mar. Absolutamente determinada a que a verdade suba a superficie. Nenhuma musica. O silencio final e total — dura ate o espectador sair da sala.
...
|----------|--------|-----------|
| Dekker (5 etapas) integrado como MOTOR narrativo, nao como citacao | OK | Etapa 4 (drift) e o arco do Ato II inteiro. Local Rationality e a logica de cada personagem. Etapa 5 (mudancas sistemicas) e SEQ 14-15 |
| Reason (Swiss Cheese) e o CLIMAX visual | OK | SEQ 13 e inteiramente construida sobre o modelo. 5 camadas animadas. Buracos acendendo em vermelho |
...
| Westrum (tipologia) usada para diagnostico, nao para rotulo | OK | Score 6/25 aparece no climax. A cultura patologica e DEMONSTRADA pelo silenciamento (SEQ 12), nao apenas mencionada |
...
| Reason (4 subculturas) presentes nas complicacoes | OK | Reporting = SEQ 07/12. Just = Carlisle silenciado. Learning = Eastland/SEQ 15. Flexible = Phillips/sistema Marconi |
| Paralelos contemporaneos VERIFICAVEIS (fontes reais) | OK | Boeing MAX: Transportation Committee Report 2020. Grenfell: Inquiry 2019-2024. Eastland: historico verificado. Crise 2008: FCIC 2011 |
...
## Step 3: Validacao Proporcoes Bernard

| Componente | Meta | Real | Status |
|------------|------|------|--------|
| **Setup (Ato I)** | ~25% (~22.5 min) | 22 min (SEQ 01-05) | 24.4% — OK |
| **Confrontacao (Ato II)** | ~50% (~45 min) | 44 min (SEQ 06-12) | 48.9% — OK |
| **Resolucao (Ato III)** | ~25% (~22.5 min) | 24 min (SEQ 13-17) | 26.7% — OK |
| **TOTAL** | 90 min | 90 min | OK |
...
| **VO total** | **~25 min** | **~28%** | **< 40% — OK** |

## Step 4: Checklist Final de Qualidade
...
| 3 | 5 Beats McKee claramente identificaveis | OK | Beat 1 (SEQ 01-04), Beat 2 (SEQ 05-06), Beat 3 (SEQ 07-12), Beat 4 (SEQ 13), Beat 5 (SEQ 14-17) |
| 4 | Turning Points bem marcados (visual + narrativo) | OK | TP1: flash branco SEQ 05 / TP2: Swiss Cheese SEQ 12-13 |
...
| 6 | Climax e revelacao SISTEMICA, nao espetacular | OK | SEQ 13: P&B puro, geometria forense, nenhum espetaculo — compreensao |
| 7 | Resolucao nao e "moral da historia" — e PERGUNTA | OK | SEQ 17 termina com pergunta ao espectador, nao com conclusao |
| 8 | Licoes Aprendidas (Fase 10) integradas organicamente | OK | 8 licoes distribuidas em SEQ 14-17 como tecido narrativo, nao como lista |
| 9 | Arco cromatico coerente (Fase 8) | OK | Ouro --> Cinza --> Verde --> P&B --> Azul-Preto. Circularidade SEQ 01/17 |
| 10 | Reconstituicoes FRAGMENTADAS, nunca naturalistas (Fase 9) | OK | N1, N2, N3 aplicados. Nenhuma cena completa. Espectador sabe que e reconstituicao |
| 11 | Entrevistas com pontos de [SILENCIO] (Fase 7) | OK | Silencios de 3, 5, 7, 10 segundos marcados em cada entrevista |
| 12 | Props-evidencia presentes (Fase 9) | OK | Rebites, cadeado binoculos, blueprints, telegrama, Merchant Shipping Act, relogio, grade |
| 13 | VO <= 40% | OK | ~28% estimado |
| 14 | Proporcoes Bernard respeitadas (25/50/25) | OK | 24.4% / 48.9% / 26.7% |
| 15 | Teste do Trem funcional (6 estacoes, zero mortas) | OK | Cada estacao narrativa tem funcao — nenhuma removivel sem colapso do arco |
| 16 | Negacao da Negacao alcancada no climax | OK | SEQ 13: nao negligencia, nao incompetencia — negligencia NORMALIZADA como paradigma |
| 17 | Call to Action nao e moralizante — e convite | OK | "Observe o que acontece" — nao "mude o mundo" |
| 18 | Paralelos contemporaneos verificaveis | OK | Fontes primarias citadas: Transportation Committee, Grenfell Inquiry, FCIC |
| 19 | Tom Cameron mantido (calmo, preciso, determinado) | OK | VO em registro de mergulho — nunca panfletario |
| 20 | Circularidade narrativa (abertura/fechamento) | OK | Mar abre, mar fecha. Azul abre, azul fecha. Mesmos sons, significado transformado |
...
|-------|-------------|--------------|
| L1 — A Regra Que Protegia Era a Que Matava | SEQ 08 (setup), SEQ 14 (contexto) | Grafismo drift + VO sobre captura regulatoria |
| L2 — O Luxo Como Anestesia | SEQ 02-03 (implicita), SEQ 14 (ironia cromatica) | Ouro Ato I como fachada; retorno opaco nos inqueritos |
| L3 — Ninguem Acorda Planejando Matar 1.517 Pessoas | SEQ 12 (reversal), SEQ 13 (climax) | Swiss Cheese + "Todos estavam certos. 1.517 morreram." |
| L4 — O Sistema Que Silencia o Alarme | SEQ 04, 07, 12 (arco do silenciamento) | Carlisle/Andrews/Phillips — triptico progressivo |
| L5 — 18 Anos de Decisoes Razoaveis | SEQ 08 (grafismo drift), SEQ 13 (time-lapse) | Regra imovel, navio crescendo — o drift visualizado |
| L6 — A Cura Que Mata | SEQ 15 (revelacao central da sequencia) | Eastland como paradoxo visceral + transicao para Boeing MAX |
| L7 — O Preco da Classe | SEQ 09 (centro da sequencia) | Grades entre decks + grafismo mortalidade |
| L8 — Voce Esta Dentro de um Drift Agora | SEQ 16-17 (ponte + epilogo) | Montagem paralela + espelho + call to action |
...
| 03 | Etapa 2 (Andrews SABIA) | — | Nivel 2 vs 3 | — | Ind. #4 |
| 04 | — | — | — | Mensageiro punido | Ind. #1 |
| 05 | Local Rationality | Camada 5 (atos) | — | — | — |
| 06 | Etapa 2 | Camada 4 (precondicoes) | — | — | — |
| 07 | Local Rationality | Camada 3 (supervisao) + Reporting FALHA | — | — | Ind. #1 |
| 08 | Etapa 4 (drift) | Camada 1 (regulacao) | — | — | Ind. #2 |
| 09 | — | Camada 2 (organizacao) | Nivel 3 (pressupostos) | — | Ind. #5 |
| 10 | Local Rationality + Second Victim | Camada 3 + Flexible FALHA | — | — | — |
| 11 | Etapa 3 (evidencia) | — | — | — | — |
| 12 | — | Reporting + Just FALHA | — | PATOLOGICA | Ind. #1 |
| 13 | Drift + Local Rationality | Swiss Cheese COMPLETO | Nivel 3 | Score 6/25 | — |
| 14 | Etapa 5 (mudancas) | Learning FALHA | Nivel 2 vs 3 | — | Ind. #2 |
| 15 | Etapa 5 (paradoxo) | Learning FALHA | — | — | — |
| 16 | Drift PRESENTE | — | — | PATOLOGICA (hoje) | Todos |
| 17 | — | — | Nivel 3 (inconsciente) | — | — |
...
| Locacao real | 1: laboratorio NIST |
| Props-evidencia | 16+: rebites, cadeado, blueprints, Merchant Shipping Act, telegrama, manipulador Morse, sino, relogio, etc. |
| Visualizacoes tecnicas (CGI) | 15: modelo 3D Titanic, Swiss Cheese, rebites microscopio, distribuicao aco/ferro, drift time-lapse, mapa Atlantico, grafismo mortalidade, crescimento navios vs regra, etc. |
| Entrevistas a filmar | 6 sessoes (Foecke, Stephenson, McCarty, Butler, Especialista, Lynch/Marschall) |
| Horas brutas estimadas | 18-24 horas |
...
*Fase 11 — Roteiro Final Consolidado | @roteirista | 2026-02-26 | FINAL DRAFT*
*Consolidacao: Fases 6 (Escaleta) + 7 (Entrevistas) + 8 (Direcao Visual) + 9 (Cenografia) + 10 (Licoes Aprendidas)*
