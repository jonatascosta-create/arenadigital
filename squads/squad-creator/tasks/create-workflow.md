...
**Quality Checklist:** Execute `checklists/create-workflow-checklist.md` at PHASE 4 (Validation) before finalizing output.
...
- Follow AIOX workflow standards (YAML format)
