...
function getEcosystemCounts(registry) {
  ...
  // Totals live in registry.summary (computed by *refresh-registry).
  // Squad count is in registry.metadata.total_squads.
  const summary = registry.summary || {};
  const meta = registry.metadata || {};
  return {
    squadCount: meta.total_squads || 0,
    agentCount: summary.total_agents || 0,
    taskCount: summary.total_tasks || 0,
    templateCount: summary.total_templates || 0,
    checklistCount: summary.total_checklists || 0,
    workflowCount: summary.total_workflows || 0,
  };
}
